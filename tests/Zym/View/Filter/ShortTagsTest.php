...
/**
 * @see Zym_View_Filter_ShortTags
 */
require_once 'Zym/View/Filter/ShortTags.php';
 ...
 * @copyright  Copyright (c) 2008 Zym. (http://www.zym-project.com/)
 */
class Zym_View_Filter_ShortTagsTest extends PHPUnit_Framework_TestCase
{
    /**
     * View filter
     *
     * @var Zym_View_Filter_ShortTags
     */
    private $_filter;
    ...
    {
        $this->_filter = new Zym_View_Filter_ShortTags();
    }
