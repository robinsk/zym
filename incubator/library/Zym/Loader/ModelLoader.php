 ...
 * @license    http://www.zym-project.com/license    New BSD License
 */
class Zym_Loader_ModelLoader extends Zym_Loader_Abstract
{
    /**
     * @var string
     */
    protected $_modelDirectory = 'models';

    /**
     * @var Zym_Loader_ModelLoader
     */
     ...
     */
    public static function load($formName, $module = null, $modelPrefix = null)
    {
